webpackJsonp([1],{1022:function(e,n){"use strict";/******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
	    ...
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          ...
	          if (_jsreportStudio2.default.extensions['licensing'].options.license === 'trial' && _jsreportStudio2.default.getAllEntities().filter(function (e) {
	            return e.__entitySet === 'templates' && !e.__isNew;
	          }).length > 5) {
	            trialModal();
	          }
	
	          if (_jsreportStudio2.default.extensions['licensing'].options.license === 'free') {
	            interval = setInterval(function () {
	              if (_jsreportStudio2.default.getAllEntities().filter(function (e) {
	                ...
	                trialModal();
	                _jsreportStudio2.default.extensions['licensing'].options.license = 'trial';
	          ...
	          _jsreportStudio2.default.addToolbarComponent(function (props) {
	            return React.createElement(
	              ...
	              React.createElement(
	                ...
	                ' ',
	                _jsreportStudio2.default.extensions['licensing'].options.license
	              )
	            );
	          }, 'settings');
